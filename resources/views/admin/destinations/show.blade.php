    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class ="flex">
                ...
                <a href="{{ route('admin.destinations.edit', $destination) }}" class="btn-link ml-auto">Edit Destination</a>

                <form action="{{ route('admin.destinations.destroy', $destination) }}" method="post">
                    @method('delete')
                    @csrf
                    <button type="submit" class="btn btn-danger ml-4" onclick="return confirm('Are you sure')">Delete Destination</button>
                </form>
                </div>
                <table>
                    <tbody>
                        ...
                        <div class="p-6 bg-white border-b border-gray-200 shadow-sj sm:rounded-lg">
                            ...
                            <div class="flex">
                            <p>
                            <img src="{{url('/images/'. $destination->picture)}}" alt="Image" width="200px"/>
                            </p>
