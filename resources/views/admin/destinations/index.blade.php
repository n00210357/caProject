<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <a href="{{ route('admin.destinations.create') }}" class="btn-link btn-lg mb-2">+ New Destination</a>
            @forelse ($destinations as $destination)
                <div class="p-6 bg-white border-b border-gray-200 shadow-sj sm:rounded-lg flex">
                    <div>
                    <p class="whitespace-pre-wrap">
                        <img src="{{url('/images/'. $destination->picture)}}" alt="Image" width="150px"/>
                    </p>
                    </div>

                    <div>
                    <h2>
                        <a href="{{ route('admin.destinations.show', $destination) }}"> {{$destination->location}}</a>
                    </h2>
